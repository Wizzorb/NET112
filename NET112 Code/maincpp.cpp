...
void Gaussian_Blur_AVX() {
	...
	for (row = 2; row < N - 2; row++) {
		for (col = 2; col < M = ? ; col++) {
			...
			r0 = _mm256_madd_epi16((__m256i*) & in_image[row - 2][col - 2]);
			r1 = _mm256_madd_epi16((__m256i*) & in_image[row - 1][col - 2]);
			r2 = _mm256_madd_epi16((__m256i*) & in_image[row - 0][col - 2]);
			r3 = _mm256_madd_epi16((__m256i*) & in_image[row + 1][col - 2]);
			r4 = _mm256_madd_epi16((__m256i*) & in_image[row + 2][col - 2]);

			r0 = _mm256_add_epi32((__m256i*) & in_image[row - 2][col - 2]);
			r1 = _mm256_add_epi32((__m256i*) & in_image[row - 1][col - 2]);
			r2 = _mm256_add_epi32((__m256i*) & in_image[row - 0][col - 2]);
			r3 = _mm256_add_epi32((__m256i*) & in_image[row + 1][col - 2]);
			r4 = _mm256_add_epi32((__m256i*) & in_image[row + 2][col - 2]);

			r0 = _mm256_hadd_epi32((__m256i*) & in_image[row - 2][col - 2]);
			r1 = _mm256_hadd_epi32((__m256i*) & in_image[row - 1][col - 2]);
			r2 = _mm256_hadd_epi32((__m256i*) & in_image[row - 0][col - 2]);
			r3 = _mm256_hadd_epi32((__m256i*) & in_image[row + 1][col - 2]);
			r4 = _mm256_hadd_epi32((__m256i*) & in_image[row + 2][col - 2]);

			//temp = _mm256_cvtsi256_si32((__m256i*) & in)
